...
//                           child: Material(
//                             color: _tempRoadmapListCheck[index] == 'dragging'
//                                 ? AppColors.g1 // 드래그 중 배경색
//                                 : AppColors.white, // 드래그 전 배경색
//                             child: ListTile(
...
//                                 style: _tempRoadmapListCheck[index] ==
//                                         'dragging'
//                                     ? AppTextStyles.bd1.copyWith(
//                                         color: AppColors.g6) // 드래그 중 텍스트 스타일
//                                     : AppTextStyles.bd2.copyWith(
//                                         color: AppColors.g6), // 드래그 전 텍스트 스타일
//                               ),
...
//                     setState(() {
//                       // 드래그 시작 시 상태 업데이트
//                       _tempRoadmapListCheck[index] = 'dragging';
//                     });
//                   },
//                   onReorderEnd: (index) {
//                     setState(() {
