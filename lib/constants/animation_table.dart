...
class AppAnimation {
  static Widget get chatting_progress_indicator => Lottie.asset(
        'assets/animation/chatting_processing.json',
        repeat: true,
      );
  static Widget get llm_thinking_background => Lottie.asset(
        'assets/animation/llm_thinking_background.json',
        repeat: true,
